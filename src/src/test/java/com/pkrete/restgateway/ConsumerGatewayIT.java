...
public class ConsumerGatewayIT extends TestCase {
    ...
    private final String contentTypeXml = Constants.TEXT_XML + ";" + Constants.CHARSET_UTF8;
    private final String contentTypejson = Constants.APPLICATION_JSON + ";" + Constants.CHARSET_UTF8;
    private final Map<String, String> urls = new HashMap<>();
    private final Map<String, Map<String, List<String>>> urlParams = new HashMap<>();
    ...
    protected void setUp() {
        ...
        // Set up test case 1
        urls.put("testConsumerGateway1", this.baseUrl + "www.hel.fi/palvelukarttaws/rest/v2/organization/");
        Map<String, List<String>> caseParams = new HashMap<>();
        List<String> values = new ArrayList<>();
        values.add("1010");
        caseParams.put(Constants.PARAM_RESOURCE_ID, values);
        this.urlParams.put("testConsumerGateway1", caseParams);

        // Set up test case 2
        urls.put("testConsumerGateway2", this.baseUrl + "www.hel.fi/palvelukarttaws/rest/v2/organization/");
        this.urlParams.put("testConsumerGateway2", new HashMap<String, List<String>>());

        // Set up test case 3
        urls.put("testConsumerGateway3", this.baseUrl + "api.finto.fi/rest/v1/search/");
        ...
        this.urlParams.put("testConsumerGateway3", caseParams);

        // Set up test case 4
        urls.put("testConsumerGateway4", this.baseUrl + "api.kirjastot.fi/v3/organisation/");
        caseParams = new HashMap<>();
        values = new ArrayList<>();
        values.add("kallio");
        ...
        this.urlParams.put("testConsumerGateway4", caseParams);
    }
    ...
    public void testConsumerGateway1Json() {
        ...
        sendData(this.urls.get("testConsumerGateway1"), "get", this.urlParams.get("testConsumerGateway1"), headers, result, contentTypejson);
    }
    ...
    public void testConsumerGateway1Xml() {
        ...
        sendData(this.urls.get("testConsumerGateway1"), "get", this.urlParams.get("testConsumerGateway1"), new HashMap<String, String>(), result, contentTypeXml);
    }
    ...
    public void testConsumerGateway2Json() {
        ...
        Map<String, String> headers = new HashMap<>();
        headers.put(Constants.HTTP_HEADER_ACCEPT, Constants.APPLICATION_JSON);
        sendData(this.urls.get("testConsumerGateway2"), "get", this.urlParams.get("testConsumerGateway2"), headers, result, contentTypejson);
    }
    ...
    public void testConsumerGateway2Xml() {
        ...
        sendData(this.urls.get("testConsumerGateway2"), "get", this.urlParams.get("testConsumerGateway2"), new HashMap<String, String>(), result, contentTypeXml);
    }
    ...
    public void testConsumerGateway3Json() {
        ...
        sendData(this.urls.get("testConsumerGateway3"), "get", this.urlParams.get("testConsumerGateway3"), headers, result, contentTypejson);
    }
    ...
    public void testConsumerGateway3Xml() {
        ...
        sendData(this.urls.get("testConsumerGateway3"), "get", this.urlParams.get("testConsumerGateway3"), new HashMap<String, String>(), result, contentTypeXml);
    }
    ...
    public void testConsumerGateway4Json() {
        ...
        Map<String, String> headers = new HashMap<>();
        headers.put(Constants.HTTP_HEADER_ACCEPT, Constants.APPLICATION_JSON);
        sendData(this.urls.get("testConsumerGateway4"), "get", this.urlParams.get("testConsumerGateway4"), headers, result, contentTypejson);
    }
    ...
    public void testConsumerGateway4Xml() {
        ...
        sendData(this.urls.get("testConsumerGateway4"), "get", this.urlParams.get("testConsumerGateway4"), new HashMap<String, String>(), result, contentTypeXml);
    }
